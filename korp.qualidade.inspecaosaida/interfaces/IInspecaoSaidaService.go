...
type IInspecaoSaidaService interface {
	BuscarInspecoesSaida(odf int, filter *models.BaseFilter) (*dto.GetInspecaoSaidaDTO, *dto.ValidacaoDTO)
	...
	CriarInspecao(input *dto.NovaInspecaoInput) (int, *dto.ValidacaoDTO)
