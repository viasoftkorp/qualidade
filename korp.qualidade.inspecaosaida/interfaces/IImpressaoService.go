...
//go:generate mockgen -destination=../mocks/mock_ImpressaoService.go -package=mocks bitbucket.org/viasoftkorp/Korp.Qualidade.InspecaoSaida/interfaces IImpressaoService
