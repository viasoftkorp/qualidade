...
const GetNotasFiscaisQuery = `
	SELECT
		...
		ESTOQUE_LOCAL.LOTE = COALESCE(HISTLISE_RATEIO_LOTE.LOTE, HISTLISE.LOTE)
...
INNER JOIN HISTLISE_RATEIO_LOTE on HISTLISE_RATEIO_LOTE.RECNO_HISTLISE = HISTLISE.R_E_C_N_O_
