...
type IInspecaoEntradaService interface {
	BuscarInspecoesEntrada(notaFiscal int, lote string, baseFilters *models.BaseFilter, filters *dto.InspecaoEntradaFilters) (*dto.GetInspecaoEntradaDTO, *dto.ValidacaoDTO, error)
	BuscarPlanosNovaInspecao(plano string, codigoProduto string, filter *models.BaseFilter) (*dto.GetPlanosInspecaoDTO, *dto.ValidacaoDTO, error)
	...
	ImprimirInspecaoEntrada(codigoInspecao int) ([]byte, *dto.ValidacaoDTO)
}
