...
func TestGetAllInspecaoEntradaHistoricoCabecalho(t *testing.T) {
	...
	mockInspecaoEntradaHistoricoRepository.EXPECT().BuscarNotasFiscaisHistoricoTotalCount(filters).
...
func TestGetAllInspecaoEntradaHistoricoItems(t *testing.T) {
	...
	mockInspecaoEntradaHistoricoRepository.EXPECT().BuscarInspecoesEntradaHistorico(notaFiscal, lote, baseFilters).
		Return(itemsRepository, nil).Times(1)
	mockInspecaoEntradaHistoricoRepository.EXPECT().BuscarQuantidadeInspecoesEntradaHistorico(notaFiscal, lote).
	...
	output, err := inspecaoEntradaHistoricoService.GetAllInspecaoEntradaHistoricoItems(notaFiscal, lote, baseFilters)
