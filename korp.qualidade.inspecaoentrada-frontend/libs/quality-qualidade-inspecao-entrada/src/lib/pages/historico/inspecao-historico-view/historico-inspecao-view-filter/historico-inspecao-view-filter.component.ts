...
import { HistoricoInspecaoEntradaFilters } from 'libs/quality-qualidade-inspecao-entrada/src/lib/tokens';
...
export class HistoricoInspecaoViewFilterComponent {
  ...
  constructor(private formBuilder: FormBuilder, @Inject(MAT_DIALOG_DATA) private filtros: HistoricoInspecaoEntradaFilters,
