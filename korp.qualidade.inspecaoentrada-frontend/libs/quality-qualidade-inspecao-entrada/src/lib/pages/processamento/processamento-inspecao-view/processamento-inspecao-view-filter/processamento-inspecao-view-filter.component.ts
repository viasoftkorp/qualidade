...
import { MovimentarInspecaoStatus, ProcessamentoInspecaoEntradaFilters } from '../../../../tokens';
...
export class ProcessamentoInspecaoViewFilterComponent {
  ...
  constructor(
  @Inject(MAT_DIALOG_DATA) private filtros: ProcessamentoInspecaoEntradaFilters,
