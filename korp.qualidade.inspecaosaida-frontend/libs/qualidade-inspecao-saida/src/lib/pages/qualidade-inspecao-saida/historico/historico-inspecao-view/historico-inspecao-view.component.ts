...
export class HistoricoInspecaoViewComponent implements OnDestroy {
  ...
  private iniciarGridHeader(): void {
    ...
    if (this.utilizarReservaPedido) {
      this.gridOptionsHeader.columns = [
        new VsGridSimpleColumn({
          ...
          width: 100,
          filterOptions: {
            useField: 'QA_INSPECAO_SAIDA.CLIENTE'
          },
          sorting: {
            useField: 'QA_INSPECAO_SAIDA.CLIENTE'
          }
        ...
        new VsGridSimpleColumn({
          ...
          width: 110,
          filterOptions: {
            useField: 'QA_INSPECAO_SAIDA.NUMPED'
          },
          sorting: {
            useField: 'QA_INSPECAO_SAIDA.NUMPED'
          }
    ...
    this.gridOptionsHeader.columns = [
      ...
      new VsGridNumberColumn({
        ...
        filterOptions: {
          useField: 'QA_INSPECAO_SAIDA.QTD_LOTE'
        },
        sorting: {
          useField: 'QA_INSPECAO_SAIDA.QTD_LOTE'
        }
  ...
  private iniciarGridItens(): void {
    ...
    this.gridOptionsItens.actions = [
      ...
      },
      {
        ...
        callback: (rowIndex: number, data: HistoricoInspecaoSaidaItensOutput) => this.imprimirInspecao(data),
  ...
  private imprimirInspecao(historicoInspecaoSaida: HistoricoInspecaoSaidaItensOutput): void {
    ...
    this.qualidadeInspecaoSaidaService.imprimirInspecaoSaida(historicoInspecaoSaida.codigoInspecao)
    .pipe(
      finalize(() => {
