...
public class AuthenticationProxyController : Viasoft.Core.Authentication.Proxy.AuthenticationProxyController
{
    public AuthenticationProxyController(IAuthenticationProxyService authenticationProxyService,
        IAmbientDataCallOptionsResolver ambientDataCallOptionsResolver) : base(authenticationProxyService,
