...
[Endpoint("Viasoft.Qualidade.RNC.ServicoSolucaoUpdated")]
public class ServicoSolucaoUpdated : IEvent
{
    public ServicoSolucaoUpdated(Solucoes.ServicoSolucao servicoSolucao, Guid id, DateTime asOfDate, Guid tenantId,
        Guid environmentId)
    {
