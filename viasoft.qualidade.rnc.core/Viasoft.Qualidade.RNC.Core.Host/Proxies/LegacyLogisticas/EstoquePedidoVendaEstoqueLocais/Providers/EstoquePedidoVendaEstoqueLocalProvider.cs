...
public class EstoquePedidoVendaEstoqueLocalProvider: IEstoquePedidoVendaEstoqueLocalProvider, ITransientDependency
{
    ...
    public EstoquePedidoVendaEstoqueLocalProvider(IApiClientCallBuilder apiClientCallBuilder,
        ICurrentCompany currentCompany)
    {
        _apiClientCallBuilder = apiClientCallBuilder;
        _currentCompany = currentCompany;
    }
    public async Task<PagedResultDto<EstoquePedidoVendaEstoqueLocalOutput>> GetList(GetListEstoqueLocalInput input)
    {
