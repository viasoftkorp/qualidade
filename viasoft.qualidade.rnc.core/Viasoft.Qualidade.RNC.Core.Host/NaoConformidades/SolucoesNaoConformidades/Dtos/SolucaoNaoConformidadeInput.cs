...
public class SolucaoNaoConformidadeInput : SolucaoNaoConformidadeModel
{
    public SolucaoNaoConformidadeInput()
    {
    }

    public SolucaoNaoConformidadeInput(SolucaoNaoConformidade solucao)
    {
        Id = solucao.Id;
