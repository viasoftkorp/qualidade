...
import { NotaFiscalSaidaOutput } from '@viasoft/rnc/api-clients/Nota-Fiscal-Saida/model';
...
export class NotasFiscaisSaidaAutocompleteSelectComponent extends VsFormManipulator<string> implements AfterViewInit {
