...
import { SolucoesNaoConformidadesModel } from '../../../../api-clients/Nao-Conformidades';
...
export class SolucoesNaoConformidadesEditorModalComponent implements AfterViewInit, OnDestroy {
  ...
  private formInit() {
    ...
    this.idSolucaoNaoConformidade = this.form.controls.id.value;
