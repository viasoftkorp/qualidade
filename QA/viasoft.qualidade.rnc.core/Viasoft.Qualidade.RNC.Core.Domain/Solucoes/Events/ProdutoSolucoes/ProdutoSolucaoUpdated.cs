...
[Endpoint("Viasoft.Qualidade.RNC.ProdutoSolucaoUpdated")]
public class ProdutoSolucaoUpdated : IEvent
{
    public ProdutoSolucaoUpdated(ProdutoSolucao produtoSolucao, Guid id, DateTime asOfDate, Guid tenantId,
        Guid environmentId)
    {
