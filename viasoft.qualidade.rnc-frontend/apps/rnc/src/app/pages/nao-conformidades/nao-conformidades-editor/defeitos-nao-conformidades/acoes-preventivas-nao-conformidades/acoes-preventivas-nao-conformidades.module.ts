...
import {
  ...
  VsFormModule, VsSelectModule, VsAutocompleteModule, VsTextareaModule, VsDatepickerModule, VsCheckboxModule, VsLayoutModule, VsSpinnerModule
...
import { ACOES_PREVENTIVAS_NAO_CONFORMIDADE_I18N_EN } from './i18n/consts/acoes-preventivas-nao-conformidades-i18n-en.const';
